Monologue.config do |config|
  ...
  #SOCIAL
  # COME-BACK NOTE: this needs to be changed!!!
  config.twitter_username = "___DisCover___"
  config.facebook_url = "https://www.facebook.com/pages/Project-DisCover/1535689803346815"
  config.facebook_logo = 'logo.png'
  config.google_plus_account_url = "https://plus.google.com/u/0/108609637715305843874"
